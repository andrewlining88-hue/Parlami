...
<div className={cx.card}><div className="flex items-center space-x-2 mb-3"><p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">📝 Study Tip of the Week</p></div>{(()=>{const tips=["Per ricordare meglio le parole nuove, scrivile e contemporaneamente leggile ad alta voce.","Non imparare solo le parole che trovi nel libro, impara anche quelle che senti in altre situazioni e che per te sono importanti.","Ogni sera scrivi in italiano cinque o sei cose che hai fatto durante la giornata.","Cerca di studiare bene solo le parole che puoi usare attivamente. Il resto basta solo capirlo.","Non è possibile tradurre letteralmente le preposizioni. Per ricordarle cerca di impararle insieme ad una parola o in una frase.","Se classifichi le parole in ordine tematico, è più facile ricordarle. Scrivi tutte le parole relative ad un argomento (es. cibi, bevande...).","Impara poche cose al giorno! E impara qualcosa tutti i giorni! Cerca di organizzare ogni giorno il momento dell'italiano.","Cerca sempre di arrivare da solo ad una regola grammaticale, perché così la ricordi meglio, ed imparala subito con un esempio.","Visualizzare le parole aiuta a ricordarle meglio. Collega le parole a delle immagini, un movimento, un rumore o un colore.","Per studiare scegli un posto tranquillo e piacevole. Non imparare più di 8 vocaboli alla volta, ma ripetili spesso.","Scrivi le parole nuove su un quaderno, con una frase come esempio. In un'altra pagina scrivi la traduzione. Ogni tanto rileggi la lista."];const week=Math.floor(Date.now()/(1000*60*60*24*7));const tip=tips[week%tips.length];return(<div className="px-3 py-3 rounded-xl" style={{background:dark?"#1c1917":"#fefce8"}}><p className="text-xs leading-relaxed" style={{color:dark?"#fbbf24":"#854d0e"}}>{tip}</p></div>);})()}</div>
