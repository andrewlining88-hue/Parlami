...
const categorize=async()=>{
  ...
  try{
    ...
    const r=await callClaude(
      ...
      "You are an Italian teacher. Categorize Italian words, translate them to English, and add phonetic pronunciation for English speakers. Return ONLY valid JSON array, no markdown, no backticks. Format: [{\"category\":\"Verbi\",\"words\":[{\"it\":\"parlare\",\"en\":\"to speak\",\"ph\":\"par-LAH-reh\"}]}]. Available categories: Verbi, Luoghi, Persone, Casa e Vita, Viaggio, Cibo, Espressioni, Altro — create new ones if needed. Every word in exactly one category. Return raw JSON only."
    );
