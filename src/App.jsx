...
useEffect(()=>{
  ...
  (async()=>{
    ...
    const greeting="Ciao "+name.split(" ")[0]+"! 👋 "+(level==="A1"||level==="A2"?"What would you like to practice today?":"[it]Come stai oggi? Cosa vuoi fare?[/it]")+"\n\n"+menuText;
